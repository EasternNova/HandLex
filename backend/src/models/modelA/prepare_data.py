...
# This file:
# G:\EasternNova\HandLex\backend\src\models\modelA\prepare_data.py
...
DEFAULT_OUTPUT_DIR = MODEL_A_DIR / "data"
...
def extract(version, limit_per_class, output_path):
    ...
    if limit_per_class:
        print("Limit per class:", limit_per_class)
    else:
        print("Limit per class: ALL")
    ...
    detector = create_landmarker(DEFAULT_MODEL)
    ...
    try:
        ...
        for class_index, class_name in enumerate(classes):
            ...
            class_dir = DEFAULT_DATASET / class_name
            ...
            for image_path in images:
                ...
                try:
                    ...
                    landmarks, handedness = get_first_hand(
                        result
                    )
            ...
            print(
                f"  Successful: {class_success}/{len(images)}"
            )
    ...
    if not output_path.is_absolute():
        output_path = MODEL_A_DIR / output_path
    ...
    print("Successful samples:", len(X))
    print("Failures:", failures)
    print("No-hand samples:", no_hand)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Prepare MediaPipe landmark dataset for HandLex ModelA"
    )
